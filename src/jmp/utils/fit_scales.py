...
def fit_scales_new(
    config: Config,
    model: Callable[[TModel], PretrainModel],
    *,
    ...
    loggers_to_suppress = [
        'jmp.lightning.model.modules.lr_monitor',
        'jmp.lightning.model.modules.wandb',
    ...
    try:
        ...
        with Trainer.context(config):
            ...
            print("Fitting scale factors for GemNet-OC backbone:")
            ...
            for name, module in scale_factors.items():
                ...
                print(f"Fitting GemNet-OC scale factor for layer {name}...")
        ...
        config.trainer.auto_set_default_root_dir = True
