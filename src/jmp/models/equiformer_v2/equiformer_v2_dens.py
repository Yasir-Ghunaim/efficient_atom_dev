...
from jmp.fairchem.core.models.base import GraphData, HeadInterface
from jmp.models.equiformer_v2.equiformer_v2 import (
    EquiformerV2Backbone,
    eqv2_init_weights,
)
from jmp.models.equiformer_v2.heads.rank2 import (
    Rank2SymmetricTensorHead,
)
from jmp.models.equiformer_v2.so3 import SO3_Embedding, SO3_LinearV2
...
if TYPE_CHECKING:
    ...
    from jmp.fairchem.core.models.base import BackboneInterface
