    ...
    def small(cls):
        return cls(
            **{
                ...
                "num_spherical": 7,
                "num_radial": 128,
                "num_blocks": 4,  # Decreased from 6 to 4
                "emb_size_atom": 256,
                "emb_size_edge": 512,  # Decreased from 1024 to 512
                "emb_size_trip_in": 64,
                "emb_size_trip_out": 64,  # Decreased from 128 to 64
                "emb_size_quad_in": 32,  # Decreased from 64 to 32
                "emb_size_quad_out": 32,
                "emb_size_aint_in": 64,
                "emb_size_aint_out": 64,
                "emb_size_rbf": 16,  # Decreased from 32 to 16
                "emb_size_cbf": 16,
                "emb_size_sbf": 32,  # Decreased from 64 to 32
                "num_before_skip": 2,
                "num_after_skip": 2,
                "num_concat": 1,  # Decreased from 4 to 1
                "num_atom": 3,
                "num_output_afteratom": 3,
                "num_atom_emb_layers": 2,
                "num_global_out_layers": 2,
